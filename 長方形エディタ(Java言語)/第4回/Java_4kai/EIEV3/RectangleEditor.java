...
public class RectangleEditor extends Applet implements ActionListener, MouseListener{
	////////////////////////////////////////////////////////////////////////////
	TextField tf_x = new TextField(), tf_y = new TextField(),			// TxF, create
			tf_w = new TextField(), tf_h = new TextField(), tf_color = new TextField();
	TextField tf_m_x = new TextField(), tf_m_y = new TextField();		// TxF, move
	TextField tf_e_x = new TextField(), tf_e_y = new TextField();		// TxF, expsrk

	Button button_create, button_delete,
	button_deleteAll, button_move, button_expsrk, button_intersect;		// Button, 6

	Label label_create = new Label("(x, y, w, h, Color)=");				// Label, create
	Label label_move = new Label("(x, y)=");							// Label, move
	Label label_expsrk = new Label("(x, y)=");							// Label, expsrk

	int AppWidth, AppHeight; 											// ?
	int mouse_counter = 0;												// mouse counter
	int rec_selected;													// rec_selected
	...
	public void mousePressed(MouseEvent e) {		// Import Material
	}
	public void mouseReleased(MouseEvent e) {		// Import Material
	}
	public void mouseEntered(MouseEvent e) {		// Import Material
	}
	public void mouseExited(MouseEvent e) {			// Import Material
	}

	@Override
	public void actionPerformed(ActionEvent e) {	// Performed.
		// TODO 自動生成されたメソッド・スタブ
