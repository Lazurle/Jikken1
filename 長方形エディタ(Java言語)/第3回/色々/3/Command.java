...
class Command {
    ...
    public boolean create() {
        ...
        try {
            System.out.print("幅：");
            int width = Integer.parseInt(reader.readLine());//reader.readlineで文字列を読み込んで、Integer.parseIntで読み込んだ文字列をint型に変換する。
            System.out.print("高さ：");
            ...
            return false;
        } catch (NumberFormatException e) {//NumberFormatExceptionは文字列をint型に変換する処理のときに使う。
